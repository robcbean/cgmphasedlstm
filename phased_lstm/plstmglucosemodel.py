...
class PlstmGlucoseModel(nn.Module):
    ...
    def __init__(self
        ...
        self.final_output = nn.Linear(in_features=_batch_size * _past_values * 2, out_features=_batch_size)
    ...
    def getModelName(self):
        ...
        ret = ret + f'_o1_{self.outputl1}_o2_{self.outputl2}_d1_{self.dropout1}_d2_{self.dropout2}'
        ret = ret + f'_ex_{self.__convert_bool(self.exp_func)}_n1_{self.nlf1}_n2_{self.nlf2}_bn_{self.__convert_bool(self.batch_normalization)}'
